...
export default class ConfigProvider {
  ...
  public getGCSOutputBucketName(): string {
    return this.getOrThrowException(
      'GCS_OUTPUT_BUCKET_NAME',
      'The name of your GCS output bucket. Example: my-bucket-name'
    );
  }

  public getGCSOutputAccessKey(): string {
    return this.getOrThrowException('GCS_OUTPUT_ACCESS_KEY', 'The access key of your GCS output bucket.');
  }

  public getGCSOutputSecretKey(): string {
    return this.getOrThrowException('GCS_OUTPUT_SECRET_KEY', 'The secret key of your GCS output bucket.');
  }

  public getGCSOutputBasePath(): string {
    return ConfigProvider.prepareS3OutputBasePath(
      this.getOrThrowException('GCS_OUTPUT_BASE_PATH', 'The base path on your GCS output bucket. Example: /outputs')
    );
  }
